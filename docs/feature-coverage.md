...
Status: current schema `1.5` coverage map
...
| Deferred | The feature is intentionally outside schema `1.5`; current inputs are diagnosed through a partial guard. |
