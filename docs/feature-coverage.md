...
Status: current schema `1.7` coverage map
...
| Deferred | The feature is intentionally outside schema `1.7`; current inputs are diagnosed through a partial guard. |
