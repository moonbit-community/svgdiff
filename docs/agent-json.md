...
- retains the same `schema_version`, analysis status, Comparison Profile, alignments, Changed Facts, source resolutions, Atomic Differences, events, Difference Regions, Cause Envelopes, magnitudes, and Diagnostics;
