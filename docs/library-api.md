...
Status: current public interface for module version `0.5.30`
...
6. serialize JSON, build HTML, or derive a non-authoritative Markdown orientation if needed;
