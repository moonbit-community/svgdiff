...
| Renderer conformance profile | `svgdiff-renderer-conformance-profile/29` | conformance fixtures, dispositions, guards, thresholds, and Rendered Evidence claims |
...
| JSON Schema | `4.0` | every serialized field, enum, omission rule, and top-level invariant |
