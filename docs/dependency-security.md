...
- the cross-platform determinism gate builds one revision on three hosted environments and covers the versioned corpus, but published binaries do not yet exist and therefore have no independent reproducibility or provenance verification.
