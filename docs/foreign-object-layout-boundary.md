...
6. **Resources**: exact caller-supplied bundles, base URL, URL resolution, MIME and decoder rules, intrinsic sizes, replaced-element sizing, CSS images and fonts, recursion, readiness, and no-implicit-I/O policy.
