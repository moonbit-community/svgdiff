...
5. For a question about the “main” change across domains, use the required schema `1.45` Impact Assessment. Under `event_rendered_pareto/v1`, report every frontier group and preserve its exact ties, incomparability, and missing-evidence status instead of comparing domain tuple numbers.
