...
5. For a question about the “main” change across domains, Schema `4.0` supplies no universal ordering. Report the independent measurements and ask for a caller concern or policy rather than comparing unlike tuple components.
