...
- [ ] **P1** Add shell completion and package-manager installation where maintainable.
...
- [ ] **P1** Version and test domain-specific lexicographic ordering tuples.
...
- [ ] **P1** Add schema examples for equivalent spelling, tiny numeric deltas, salient changes, insertion/deletion, resources, and partial coverage.
- [ ] **P1** Define JSON Schema compatibility and migration tests for every released schema version.
...
- [ ] **P0** Keep generated HTML sandboxed and safe for hostile SVG source.
...
- [ ] `svgdiff before.svg after.svg` works after a documented installation step.
