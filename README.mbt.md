...
Run version `0.8.0` directly from Mooncakes:
...
test "serialize JSON and build the HTML presentation" {
  ...
  assert_true(json.find("\"schema_version\": \"3.0\"") is Some(_))
