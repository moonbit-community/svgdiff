...
git tag -a v0.4.0 -m "svgdiff v0.4.0"
git push origin v0.4.0
```

Replace `0.4.0` with the current `moon.mod` version. The workflow rejects any mismatch before packaging and uses `--verify-tag` before publication.
