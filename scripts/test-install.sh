...
jq -e '.schema_version == "1.45" and .profile.renderer_conformance_profile_id == "svgdiff-renderer-conformance-profile/25" and (.atomic_differences | length) == 1 and .impact_assessment.policy_id == "event_rendered_pareto/v1"' agent.json >/dev/null
