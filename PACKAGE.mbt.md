...
- `PerceptualBackground::parse_srgb` for optional normalized opaque sRGB8 display-policy input that leaves current transparent-canvas evidence unchanged;
