...
- `PerceptualBackground::parse_srgb` and `FlipViewingConditions::from_pixels_per_degree` for optional explicit perceptual inputs that leave current transparent-canvas evidence unchanged;
