...
- the Playwright-managed Chromium selected by [`.playwright/cli.config.json`](../../.playwright/cli.config.json), with the exact user agent recorded in every output;
