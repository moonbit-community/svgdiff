...
The accepted policy was established under Schema `1.43` and module version `0.5.23`. This active regression now replays it under current Schema `2.0`; the Impact policy, complete inventories, query-conditioned interpretation, and rejection of production concern fields remain unchanged.
