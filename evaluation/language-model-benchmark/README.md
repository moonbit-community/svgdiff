...
Report-region overlap and report Cause Envelope recall remain modules/svgdiff/engine/report metrics. The model receives no credit for producing them; they stay visible beside the Agent metrics so input-report failure cannot be disguised as Agent success.
