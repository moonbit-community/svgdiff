...
This gate changes no product format or policy. Structured Report Schema `1.44`, projection `svgdiff-agent-projection/1`, Impact policy `event_rendered_pareto/v1`, and the derived-only Markdown authority remain unchanged.
