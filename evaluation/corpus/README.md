...
The initial corpus covers equivalent authored spelling, a subtle continuous geometry delta, a salient paint change, structural insertion, a referenced-resource change, a zero-contribution insertion, and unsupported path semantics.
